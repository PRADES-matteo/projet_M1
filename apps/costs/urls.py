...
urlpatterns = [
    ...
    # Centres d'analyse
    path("scenario/<int:scenario_id>/centers/", views.manage_cost_centers, name="manage_cost_centers"),
    path("scenario/<int:scenario_id>/centers/<int:center_id>/edit/", views.edit_cost_center, name="edit_cost_center"),
    path("scenario/<int:scenario_id>/centers/<int:center_id>/delete/", views.delete_cost_center, name="delete_cost_center"),
    path("scenario/<int:scenario_id>/centers/<int:center_id>/allocations/", views.manage_allocations, name="manage_allocations"),
    path("scenario/<int:scenario_id>/allocations/<int:allocation_id>/delete/", views.delete_allocation, name="delete_allocation"),
    path("scenario/<int:scenario_id>/centers/<int:center_id>/charges/", views.manage_center_charges, name="manage_center_charges"),
    path("scenario/<int:scenario_id>/centers/<int:center_id>/charges/<int:line_id>/delete/", views.delete_center_charge, name="delete_center_charge"),
    path("scenario/<int:scenario_id>/usages/", views.manage_product_usages, name="manage_product_usages"),
    path("scenario/<int:scenario_id>/center-analysis/results/", views.center_analysis_results, name="center_analysis_results"),
]